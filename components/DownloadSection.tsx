        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-16 items-center max-w-6xl mx-auto">
          <div className="space-y-6">
            ...
            <p className="text-base md:text-lg leading-relaxed text-foreground">
              ...
              Diemex can help you tap into Eurasia's growing tourism market and build valuable partnerships.
            </p>
          ...
          <div className="relative flex justify-center items-center">
            <img
              src="/MITT-event-brochure-mockup-stack.jpg"
              alt="Diemex Event Brochure"
